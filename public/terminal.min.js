...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => /* binding */ TwitchModule\n/* harmony export */ });\n/* harmony import */ var _services_twitch_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./services/twitch.js */ \"./src/modules/services/twitch.js\");\n/* harmony import */ var _services_twitch_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_services_twitch_js__WEBPACK_IMPORTED_MODULE_0__);\n\r\n\r\nconst commands = {\r\n\r\n    // brute force clip assets by *Stream* id\r\n    async streamClips(args) {\r\n        if(args[0]) {\r\n            return await (0,_services_twitch_js__WEBPACK_IMPORTED_MODULE_0__.queryClipsByStreamId)(args[0]);\r\n        } else {\r\n            return \"Provide twitch login name.\";\r\n        }\r\n    },\r\n\r\n    // get first 100 vods by user login\r\n    async vod(args) {\r\n        if(args[0]) {\r\n            return await (0,_services_twitch_js__WEBPACK_IMPORTED_MODULE_0__.getVODsByUser)(args[0]);\r\n        } else {\r\n            return \"Provide twitch login name.\";\r\n        }\r\n    },\r\n\r\n    // get stream info by user login\r\n    async stream(args) {\r\n        if(args[0]) {\r\n            return await (0,_services_twitch_js__WEBPACK_IMPORTED_MODULE_0__.getStreamsByUser)(args[0]);\r\n        } else {\r\n            return \"Provide twitch login name.\";\r\n        }\r\n    },\r\n\r\n    // get user info by user login\r\n    async user(args) {\r\n        if(args[0]) {\r\n            const userInfo = await (0,_services_twitch_js__WEBPACK_IMPORTED_MODULE_0__.getUserByLogin)(args[0]);\r\n            return userInfo.data[0];\r\n        } else {\r\n            return \"Provide twitch login name.\";\r\n        }\r\n    },\r\n\r\n    // see following channels by user login\r\n    following(args) {\r\n        if(args[0]) {\r\n            (0,_services_twitch_js__WEBPACK_IMPORTED_MODULE_0__.getUserFollowers)(args[0]);\r\n        } else {\r\n            return \"Provide twitch login name!\";\r\n        }\r\n    },\r\n\r\n    // see all followers of a user login\r\n    followers(args) {\r\n        if(args[0]) {\r\n            (0,_services_twitch_js__WEBPACK_IMPORTED_MODULE_0__.getChannelAllFollowers)(args[0]);\r\n        } else {\r\n            return \"Provide twitch login name!\";\r\n        }\r\n    },\r\n\r\n    // compare viewrship by two user logins\r\n    viewership(args) {\r\n        if(args[0] && args[1]) {\r\n            (0,_services_twitch_js__WEBPACK_IMPORTED_MODULE_0__.getChannelViewerOverlap)(args[0], args[1]);\r\n        } else {\r\n            return \"Provide twitch login name!\";\r\n        }\r\n    }\r\n\r\n}\r\n\r\nlet Console;\r\n\r\nclass TwitchModule extends ConsoleModule {\r\n    \r\n    static get moduleName() {\r\n        return \"twitch-module\";\r\n    }\r\n    \r\n    static get commandName() {\r\n        return \"twitch\";\r\n    }\r\n    \r\n    static install(cnsl) {\r\n        Console = cnsl;\r\n    }\r\n\r\n    static async run(arguemnts) {\r\n        (0,_services_twitch_js__WEBPACK_IMPORTED_MODULE_0__.setConsole)(Console);\r\n        const command = arguemnts[0];\r\n        const args = arguemnts.slice(1);\r\n\r\n        if(command in commands) {\r\n            const output = await commands[command](args);\r\n            if(output) {\r\n                Console.print(output);\r\n            }\r\n        } else {\r\n            Console.print('Unknown command');\r\n            Console.print(`Commands: ${Object.keys(commands)}`);\r\n        }\r\n    }\r\n\r\n}\n\n//# sourceURL=webpack://terminal/./src/modules/twitch.js?");
